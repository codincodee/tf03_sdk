...
protected:
  ...
  void Spin() override;
  bool I037BurnCallback(std::list<MiniCartStep29B> steps) override;
  bool I037TempBurnCallback(std::list<MiniCartStep29B> steps) override;
  bool AutoIntCheckCallback(std::list<MiniCartStep29B> steps) override;
private:
